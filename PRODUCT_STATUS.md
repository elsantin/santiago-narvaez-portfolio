...
- **Posicionamiento y Copywriting:**
  - Hero: *Ficción visual y narrativa sintética*.
  - Perfil/About: Narrativa de creador audiovisual con formación formal en Ciencias Audiovisuales y Fotografía.
  - Galería: *Obras Selectas / Selected Works* + subtítulo por categorías.
  - Navegación bilingüe (ES / EN) en todo el sitio.
- **Interfaz y Experiencia (UI/UX):**
  - Navegación fija con efecto *glassmorphism*.
  - Menú desplegable móvil (Drawer) animado.
  - Smooth scroll entre secciones.
  - Hero CTA: Ghost button rectangular con flecha en accent color.
  - Hero móvil inmersivo: foto a `95%` de opacidad con sombras de contraste tipográfico.
